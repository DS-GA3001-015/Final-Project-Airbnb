...
shinyServer(function(input, output, session) {
  ...
  observeInputs <- observeEvent(input$submit,{
    ...
    #print(proc.time()-t1)
    relative_hosts = data.table::fread("./data/relative_hosts.csv")
    if(input$year==2016){
  ...
  observeEvent(input$submit3,{
    ...
    file_read_short=c("2017_July","2017_August","2017_September","2017_October","2017_November","2017_December")
  ...
  observeEvent(input$submit4,{
    ...
    #print(keyid)
    multiple = data.table::fread("./data/total_multiple.csv")
