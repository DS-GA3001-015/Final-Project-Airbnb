...
labs(title= "cost variation with tourist palce", x= "Tourist Place", y = 'Price in $') + theme(axis.text.x = element_text(angle=90, vjust=0.6))
...
labs(title= "Airbnb Commercial Listing Cost variation with Tourist palce", x= "Tourist Place", y = 'Price in $') + theme(axis.text.x = element_text(angle=90, vjust=0.6))
...
labs(title= "Airbnb Non Commercial Listing Cost variation with Tourist palce", x= "Tourist Place", y = 'Price in $') + theme(axis.text.x = element_text(angle=90, vjust=0.6))
...
labs(title= "Nearest Airbnb to the tourist place", x= "Tourist Place", y = 'Nearest Distnace in mtrs') + theme(axis.text.x = element_text(angle=90, vjust=0.6))
...
names(Combined_rental_airbnb)[2]<-"Time_Period"

Combined_rental_airbnb<-arrange(Combined_rental_airbnb, desc(Time_Period))

#time vs price
plot_ly(Combined_rental_airbnb, x = ~Time_Period , y = ~Airbnb_Prices, name='Airbnb',type = 'scatter', mode='lines',
              color = ~Boro)%>%add_trace(y=~Rental_Prices, name='Rentals',type = 'scatter', mode='lines', line=list(width= 4,dash='dot') )%>%layout(xaxis=list(title="",tickangle=45 ),yaxis=list(title="Median Price"))%>%layout(xaxis = list(autorange = "reversed"))


#ime vs Occupancy
plot_ly(Combined_occupancy_airbnb, x = ~Time_Period , y = ~Airbnb_Occupancy_Rate, name='Airbnb',type = 'scatter', mode='lines',
              color = ~Boro)%>%add_trace(y=~Rental_Occupancy_Rate, name='Rentals',type = 'scatter', mode='lines', line=list(width= 4,dash='dot') )%>%layout(xaxis=list(title="",tickangle=45 ),yaxis=list(title="Occupancy Rate"))%>%layout(xaxis = list(autorange = "reversed"))
